...
function floorGrid(ctx){
  ...
  sl.addColorStop(1,"rgba(160,200,255,0)");
  face(ctx,[P(0,0,0),P(WX,0,0),P(WX,WY,0),P(0,WY,0)],sl);
  for(let x=0;x<=WX;x+=2)seg(ctx,P(x,0,0),P(x,WY,0),x%4?"rgba(0,0,0,.18)":"rgba(0,0,0,.34)",x%4?1:1.4);
  for(let y=0;y<=WY;y+=2)seg(ctx,P(0,y,0),P(WX,y,0),y%4?"rgba(0,0,0,.18)":"rgba(0,0,0,.34)",y%4?1:1.4);
