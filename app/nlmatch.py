...
RECIPE_KEYWORDS: dict[str, list[str]] = {
    ...
    "fnb_fill_cutoff": ["정량", "충전 차단", "로드셀", "음료", "그램", "식품"],
    "battery_formation": ["화성", "셀", "전압", "컷오프", "과열", "배터리", "이차전지"],
    ...
    "transfer_line": ["트랜스퍼", "차체", "보디샵", "바디샵", "조립라인", "스테이션", "이송바",
                      "자동차라인", "양산라인", "동기용접", "다중로봇", "transfer", "body",
                      "bodyshop", "station"],
    "paint_booth": ["도장", "부스", "스프레이", "분사", "퍼지", "도료", "세정", "도장부스",
                    "급기", "배기", "paint", "spray", "booth", "purge"],
    "stretch_wrap": ["랩핑", "랩핑기", "스트레치", "필름", "턴테이블", "권취", "포장기",
                     "파레트포장", "wrap", "stretch", "film", "turntable"],
    "oht_transport": ["천장반송", "반송", "호이스트", "웨이퍼", "캐리어", "풉", "포드", "팹",
                      "클린룸", "oht", "hoist", "foup", "amhs", "wafer"],
    "palletizer": ["파레타이저", "적재", "층", "푸셔", "파레트적재", "박스적재", "단적재",
                   "palletizer", "layer", "pusher", "stack"],
    "cluster_tool": ["클러스터", "로드락", "진공", "챔버", "트랜스퍼챔버", "매엽", "식각",
                     "증착", "공정챔버", "웨이퍼이송", "cluster", "loadlock", "vacuum",
                     "chamber", "etch", "cvd"],
    "dust_collector": ["집진", "집진기", "백워시", "역세", "차압", "필터", "펄스밸브", "분진",
                       "백필터", "dust", "bag", "pulse", "backwash"],
    "dosing_mix": ["정량혼합", "2액", "이액", "약액", "투입", "혼합비", "적산", "유량계",
                   "도징", "배합", "dosing", "mix", "ratio", "chemical"],
