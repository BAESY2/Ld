...
_BOM: dict[str, list[str]] = {
    "motor": ["3상 유도전동기", "전자접촉기(MC)", "열동계전기(EOCR)", "배선용차단기(MCCB)"],
    "pump": ["원심펌프", "메커니컬 씰", "흡입 스트레이너", "체크밸브", "커플링"],
    "valve": ["솔레노이드 밸브(2포트)", "수동 차단밸브", "개도 리밋스위치"],
    "heater": ["시즈히터", "SSR 릴레이", "과열방지 서모스탯"],
    "cooler": ["축류팬", "방진 마운트", "휀가드"],
    "fan": ["축류팬", "방진 마운트", "휀가드"],
    "conveyor": ["기어드모터", "구동/종동 롤러", "벨트", "장력 조절기"],
    "beacon": ["LED 경광등", "부저", "취부 폴"],
    "ejector": ["공압 실린더", "5포트 솔밸브", "스피드 컨트롤러", "리드 스위치 2점"],
    "gate": ["공압 실린더", "가이드 레일", "리밋 스위치 2점"],
    "mixer": ["교반 전동기", "감속기", "임펠러"],
    "actuator": ["범용 액추에이터", "구동 릴레이"],
