...
def run() -> dict[str, object]:
    ...
    lines.append(
        ...
        "그러나 (1) 다중 서브시스템을 한 조각으로 축약하고, (2) 퍼센트/목표값/대수제어 "
        "같은 정량·관계 의미를 디지털 근사로 뭉개거나 놓치며, (3) 범위밖은 확신강등으로 "
        "비교적 정직히 거절하지만 키워드 표면이 겹치면 누출 위험이 남는다. "
        "compound 의 '전체의도 캡처 0%'가 키워드 매처의 천장을 가장 또렷이 보여준다."
    )
